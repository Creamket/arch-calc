        ...
        <>
          ...
          {result.cross
            ...
            ? `На приопорных участках установить поперечную арматуру с шагом не более ${
                0.5 * result.height < 0.15 ? 0.5 * result.height : 0.15
              } м на участке ${0.25 * result.length} м от опоры. `
            : `На приопорных участках установить поперечную арматуру с шагом не более ${
                0.33 * result.height < 0.5 ? 0.33 * result.height : 0.5
              } м на участке ${0.25 * result.length} м от опоры. `}
          <br />
          {!result.cross &&
            `В остальной части пролета ${
              result.height > 0.3
                ? `установить поперечную арматуру с шагом не более ${
                    0.75 * result.height < 0.5 ? 0.75 * result.height : 0.5
                  } м.`
